...
const AuthScreen = () => {
    ...
    return (
        <div className="hero-bg relative">
            {/* Navbar */}
            <header className="max-w-6x1 mx-auto flex items-center justify-between p-4 pb-10"> 
            ...
            <form className="flex flex-col md:flex-row gap-4 w-1/2"  onSubmit={handleFormSubmit}>
                        ...
                        />
                        <button className="bg-red-600 text-x1 lg:text2x1 px-2 lg:px-6 py-1 md:py-2 rounded flex justify-center items-center">
                            Get Started
            ...
            <div className="py-10 bg-black text-white">
                <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
                    ...
                    <div className="flex-1 text-center md:text-left">
                        <h2 className="text-4x1 md:text-5x1 font-extrabold mb-4">Enjoy your TV</h2>
                ...
                <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2">
                    ...
                    <div className="flex-1">
                        <div className="relative">
                            ...
                            w-3/4 lg:w-1/2 h-24 border border-slate-500 rounded-md px-2">
                                <img src="/stranger-things-sm.png" alt='stranger things image'
                                className="h-full"/>
                    ...
                    <div className="flex-1 text-center md:text-left">
                        <h2 className="text-4x1 md:text-5x1 font-extrabold mb-4">
                            Dowload and watch right on Netflix
                        </h2>
                        <p className="text-lg md:text-xl">
